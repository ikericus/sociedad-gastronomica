    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {            
            ...
            $availability = ($value['active'] == 1) ? '<span class="label label-success">Activo</span>' : '<span class="label label-warning">Inactivo</span>';
    ...
    */
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		$this->session->set_flashdata('success', 'Producto creado con éxito');
	...
	public function remove()
	{
        ...
        if($product_id) {
            ...
            if($delete == true) {
                ...
                $response['messages'] = "Producto eliminado"; 
            }
            else {
            ...
            $response['success'] = false;
            $response['messages'] = "Ha ocurrido un error, refresca la página por favor";
        }
