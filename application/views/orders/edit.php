          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="date" class="col-sm-12 control-label">Fecha: <?php echo date('d-m-Y') ?></label>
                  <label for="time" class="col-sm-12 control-label">Hora: <?php echo date('H:i:s') ?></label>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('orders/') ?>" class="btn btn-warning">Salir</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
