    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <!-- <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('reports/intakes') ?>" method="POST">
...
<!-- 
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Consumos agregados por meses - Gráfico</h3>
            </div>
            <div class="box-body">
              <div class="chart">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Consumos agregados por meses - Tabla</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $("#intakesReportSubMenu").addClass('active');
    }); 
