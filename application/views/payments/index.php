    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createPayment', $user_permission)): ?>
          <a href="<?php echo base_url('payments/create') ?>" class="btn btn-primary">Añadir pago</a>          
        <?php endif; ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('payments/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
          <p>¿Realmente quieres eliminar el pago?</p>
        </div>
