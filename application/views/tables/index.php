      ...
      <form role="form" action="<?php echo base_url('tables/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="table_name" name="table_name" placeholder="Introduce nombre de la mesa" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="brand_name">Capacidad</label>
            <input type="text" class="form-control" id="capacity" name="capacity" placeholder="Introduce capacidad" autocomplete="off">
          </div>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tables/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Nombre de la mesa</label>
            <input type="text" class="form-control" id="edit_table_name" name="edit_table_name" placeholder="Introduce nombre de la mesa" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="brand_name">Capacidad</label>
            <input type="text" class="form-control" id="edit_capacity" name="edit_capacity" placeholder="Introduce capacidad de la mesa" autocomplete="off">
          </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tables/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
          <p>¿Realmente quieres eliminar la mesa?</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
          <button type="submit" class="btn btn-primary">Guardar cambios</button>
